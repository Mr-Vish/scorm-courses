...
function showModal(title, message) {
    ...
    modal.innerHTML = '<div class="modal-content"><div class="modal-title">' + title + '</div><div class="modal-message">' + message + '</div><button class="modal-button" onclick="this.closest(\'.custom-modal\').remove()">OK</button></div>';
...
function getAPI()
{
   ...
   if (theAPI == null)
   {
      ...
      showModal("API Error", "Unable to find an API adapter");
   }
   return theAPI;
}
...
function ScormProcessInitialize(){
    ...
    if (API == null){
        showModal("Connection Error", "ERROR - Could not establish a connection with the LMS.\n\nYour results may not be recorded.");
        return;
    }
